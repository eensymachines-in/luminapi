...
(function () {
    angular.module("luminapp").service("srvApi", function ($timeout, $q, baseURL, $http, $window, lclStorage, $location) {
        ...
        // overriding the baseURL object from the arguments 
        // We no longer intend to hard code the url in the application config 
        var baseURL = function() {
            var base_url = function () {
                // forms the base url from $location..
                // baseURL from the arguments is overriden here
            ...
            this.auth = "http://auth.eensymachines.in";
            this.lumin = base_url() + "/api/v1/devices";
            this.cmds = base_url() + "/api/v1/cmds";
            return this
        }
        ...
        this.authorize = function (_email, auth, refr, lvl) {
            if (auth == refr) {
            ...
            $http(request).then(function (_response) {
